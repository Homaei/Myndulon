...
- SystemSetting: Dynamic application configuration
"""
...
class SystemSetting(Base):
    ...
    Stores dynamic configuration that overrides env vars.
    Key-value store for things like AI provider, API keys, etc.
    """
