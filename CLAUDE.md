...
Myndulon is an open-source, self-hostable AI chatbot widget that enables businesses to add AI-powered customer support to their websites. The system creates a knowledge base from provided content (URL scraping or direct text input) and uses RAG (Retrieval-Augmented Generation) to answer visitor questions.
...
- Collection name: `myndulon_embeddings`
